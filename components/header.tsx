...
const socialLinks = [
  { label: "Email", href: "mailto:mailtoteam48@gmail.com", icon: Github },
]
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/login"
              className="hidden items-center gap-2 font-mono text-xs text-muted-foreground sm:flex px-3 py-1.5 rounded-lg bg-primary/10 border border-primary/30 hover:border-primary/50 hover:text-primary transition-all duration-300"
            >
              <span>Sign In</span>
            </Link>
